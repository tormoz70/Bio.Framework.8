  ...
  public class AjaxMng : IAjaxMng {
    ...
    private void _request(BioRequest bioRequest) {
      ...
      if (bioRequest.URL == null) {
        bioRequest.URL = BioEnvironment.Instance.ServerUrl; //Utl.BuildURL(this.ServerUrl, null);
      }
      ...
      this._ajax.Request(bioRequest, BioEnvironment.Instance.ConfigRoot.RequestTimeout);
    }
