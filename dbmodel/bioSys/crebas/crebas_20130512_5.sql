...
/* Created on:     12.05.2013 14:33:41                          */
/*==============================================================*/
...
--WARNING: The following insert order will not restore columns: USR_ID
...
--WARNING: The following insert order will not restore columns: USR_ID
insert into USRGRNT (GRANT_UID, USR_UID)
select GRANT_UID, ?
from "tmp_USRGRNT";
...
--WARNING: The following insert order will not restore columns: USR_ID
insert into USRLOG (USRLOG_ID, USR_UID, IOBJ_CD, IOBJ_ID, ACTION_TEXT, ACT_DATE, IOBJ_MASTER_CD, IOBJ_MASTER_ID)
