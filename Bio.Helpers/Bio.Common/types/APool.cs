...
namespace Bio.Helpers.Common {
    ...
    /// <summary/>
    public interface IPoolMethods : IDisposable {
      /// <summary>
    ...
    /// to classes that implement the IPoolMethods interface
    /// </summary>
    /// <remarks>
    ...
    /// </typeparam>
    public class APool<T> where T : IPoolMethods, new() {
      /// <summary>
      ...
      /// </summary>
      private readonly LinkedList<WeakReference> objectPool = new LinkedList<WeakReference>();
      /// <summary>
      ...
      /// </returns>
      public static APool<T> GetInstance() {
        return _instance;
      }
      /// <summary>
      ...
      /// </exception>
      private void _objectDisposing(object sender, EventArgs e) {
      ...
      /// IPoolMethods.SetupObject method. Need to find a
      ...
      public T GetObjectFromPool(params object[] setupParameters) {
        ...
        lock (this) {
          ...
          foreach (var weak in objectPool) {
            var o = weak.Target;
            if (o != null) {
              remove = weak;
              result = (T)o;
        ...
        if (result == null) {
          result = new T();
          result.Disposing += _objectDisposing;
        }
        result.SetupObject(setupParameters);
        return result;
#endif
