...
namespace Bio.Helpers.Controls.SL {
  ...
  public class FloatableWindow : ContentControl {
    ...
    private Boolean _showStarted = false;
    private void _doOnShow(Object sender, EventArgs e) {
...
//#endif
    ...
    public virtual void Show(double horizontalOffset, double verticalOffset) {
      this._horizontalOffset = horizontalOffset;
      this._verticalOffset = verticalOffset;
      this._showWindow(false);
    }

    private void _showWindow(bool isModal) {
